  ...
  module Trackable
    ...
    module ClassMethods
      def track_history(options={})
        ...
        belongs_to options[:master_field].to_sym, :class_name => Mongoid::Audit.master_class_name, inverse_of: nil
    ...
    module MyInstanceMethods
      ...
      def undo!(modifier, master, options_or_version=nil)
        ...
        versions.each do |v|
          undo_attr = v.undo_attr(modifier, master)
          self.attributes = v.undo_attr(modifier, master)
        end
        save!
      end
      ...
      def redo!(modifier, master, options_or_version=nil)
        ...
        versions.each do |v|
          redo_attr = v.redo_attr(modifier, master)
